...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Smarter Cool | Climatización industrial" },
      { name: "description", content: "Equipos evaporativos, ventiladores HVLS y extractores para climatizar grandes espacios comerciales e industriales." },
      { name: "author", content: "Lovable" },
      { property: "og:title", content: "Smarter Cool | Climatización industrial" },
      { property: "og:description", content: "Equipos evaporativos, ventiladores HVLS y extractores para climatizar grandes espacios comerciales e industriales." },
